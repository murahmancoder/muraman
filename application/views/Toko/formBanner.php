             ...
             <form action="<?=$action;?>" method="post" enctype="multipart/form-data">
              <div class="row">
               <div class="form-group col-md-12">
                  <label  class="font-weight-bold">Nama Banner</label>
                  <input type="text"  name="banner" class="form-control" value="<?= set_value('banner', $banner->banner ?? '');?>" required>
               </div>

               <div class="form-group col-md-12">
                  <label  class="font-weight-bold">Link Produk / Barang </label>
                  <input type="url" placeholder="http://localhost/muraman/toko/barang/laptop" name="link" class="form-control" value="<?= set_value('link', $banner->link ??'');?>" required>
               </div>
